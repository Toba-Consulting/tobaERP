...
@org.adempiere.base.Model(table="A_AssetTransfer")
...
// @#Date@
			setDocumentNo (null);
			setNew_Asset_Group_ID (0);
        } */
    }
    
    /** Standard Constructor */
    public X_A_AssetTransfer (Properties ctx, String A_AssetTransfer_UU, String trxName)
    {
	...
	/** Set Asset Transfer.
		@param A_AssetTransfer_ID Asset Transfer	  */
    ...
    {
        return new KeyNamePair(get_ID(), String.valueOf(getA_AssetTransfer_ID()));
    }
	...
	{
		set_Value (COLUMNNAME_A_AssetTransfer_UU, A_AssetTransfer_UU);
	}
