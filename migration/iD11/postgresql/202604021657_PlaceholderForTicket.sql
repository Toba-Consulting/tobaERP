...
ALTER TABLE Fact_Acct ADD COLUMN isreversecorrect CHAR(1) DEFAULT 'N' CHECK (isreversecorrect IN ('Y','N')) NOT NULL
;

-- 02/Apr/2026 16:58:10
INSERT INTO t_alter_column values('fact_acct','isreversecorrect','CHAR(1)',null,'N')
;
