...
public class MBPVInvAcctByCurrency extends X_C_BP_V_InvAcctByCurrency{

	public MBPVInvAcctByCurrency (Properties ctx, int C_BP_V_InvAcctByCurrency_ID, String trxName){
      super (ctx, C_BP_V_InvAcctByCurrency_ID, trxName);
    }
	
	public MBPVInvAcctByCurrency (Properties ctx, ResultSet rs, String trxName)
    {
