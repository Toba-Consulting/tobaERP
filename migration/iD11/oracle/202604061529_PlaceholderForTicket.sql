...
ALTER TABLE M_InventoryLine MODIFY C_UOM_ID NUMBER(10) DEFAULT NULL 
;

-- 06/Apr/2026 15:31:51
ALTER TABLE M_InventoryLine ADD IsUnitCost CHAR(1) DEFAULT 'N' CHECK (IsUnitCost IN ('Y','N')) NOT NULL
;
...
ALTER TABLE M_InventoryLine MODIFY IsUnitCost CHAR(1) DEFAULT 'N'
;
...
ALTER TABLE M_InventoryLine ADD UnitCost NUMBER DEFAULT NULL 
;
...
ALTER TABLE M_InventoryLine MODIFY UnitCost NUMBER DEFAULT NULL 
;
...
ALTER TABLE M_InventoryLine ADD UnitCostEntered NUMBER DEFAULT NULL 
;
