...
/** Generated Model for T_AgingDaily
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_T_AgingDaily extends PO implements I_T_AgingDaily, I_Persistent 
{
    ...
    public X_T_AgingDaily (Properties ctx, int T_AgingDaily_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_T_AgingDaily (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_T_AgingDaily[")
	...
	{
		set_Value (COLUMNNAME_DueIn1, DueIn1);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_DueIn1);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		set_Value (COLUMNNAME_DueIn2, DueIn2);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_DueIn2);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		set_Value (COLUMNNAME_DueIn3, DueIn3);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_DueIn3);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		set_Value (COLUMNNAME_DueIn4, DueIn4);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_DueIn4);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		set_Value (COLUMNNAME_DueIn5, DueIn5);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_DueIn5);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		set_Value (COLUMNNAME_DueIn6, DueIn6);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_DueIn6);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set T_AgingDaily_UU.
		@param T_AgingDaily_UU T_AgingDaily_UU	  */
	public void setT_AgingDaily_UU (String T_AgingDaily_UU)
	{
		set_Value (COLUMNNAME_T_AgingDaily_UU, T_AgingDaily_UU);
	}

	/** Get T_AgingDaily_UU.
		@return T_AgingDaily_UU	  */
	public String getT_AgingDaily_UU () 
	{
		return (String)get_Value(COLUMNNAME_T_AgingDaily_UU);
	}
}