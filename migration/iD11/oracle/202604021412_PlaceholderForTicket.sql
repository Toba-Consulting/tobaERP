...
-- 02/Apr/2026 14:32:12
CREATE TABLE M_Periodic_Cost (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, C_Period_ID NUMBER(10) DEFAULT NULL , Created DATE DEFAULT SYSDATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, M_AttributeSetInstance_ID NUMBER(10) DEFAULT NULL , M_Periodic_Cost_ID NUMBER(10) DEFAULT NULL , M_Periodic_Cost_UU VARCHAR2(36 CHAR) DEFAULT NULL , M_Product_Category_ID NUMBER(10) DEFAULT NULL , M_Product_ID NUMBER(10) DEFAULT NULL , Updated DATE DEFAULT SYSDATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, beginningqty NUMBER DEFAULT NULL , beginnningamount NUMBER DEFAULT NULL , costprice NUMBER DEFAULT NULL , endingamount NUMBER DEFAULT NULL , endingqty NUMBER DEFAULT NULL , ipv_amount NUMBER DEFAULT NULL , issueamount NUMBER DEFAULT NULL , issueqty NUMBER DEFAULT NULL , landedcostamount NUMBER DEFAULT NULL , receiptamount NUMBER DEFAULT NULL , receiptqty NUMBER DEFAULT NULL , CONSTRAINT M_Periodic_Cost_Key PRIMARY KEY (M_Periodic_Cost_ID), CONSTRAINT M_Periodic_Cost_UU_idx UNIQUE (M_Periodic_Cost_UU))
;
