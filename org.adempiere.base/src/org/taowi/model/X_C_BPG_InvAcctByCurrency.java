...
/** Generated Model for C_BPG_InvAcctByCurrency
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_C_BPG_InvAcctByCurrency extends PO implements I_C_BPG_InvAcctByCurrency, I_Persistent 
{
    ...
    public X_C_BPG_InvAcctByCurrency (Properties ctx, int C_BPG_InvAcctByCurrency_ID, String trxName)
    {
      ...
      /** if (C_BPG_InvAcctByCurrency_ID == 0)
        {
			...
			setC_BP_Group_ID (0);
// @C_BP_Group_ID@
			setC_BPG_InvAcctByCurrency_ID (0);
			setC_Currency_ID (0);
    ...
    /** Load Constructor */
    public X_C_BPG_InvAcctByCurrency (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_BPG_InvAcctByCurrency[")
	...
	/** Set C_BPG_InvAcctByCurrency.
		@param C_BPG_InvAcctByCurrency_ID C_BPG_InvAcctByCurrency	  */
	public void setC_BPG_InvAcctByCurrency_ID (int C_BPG_InvAcctByCurrency_ID)
	{
		if (C_BPG_InvAcctByCurrency_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_BPG_InvAcctByCurrency_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_BPG_InvAcctByCurrency_ID, Integer.valueOf(C_BPG_InvAcctByCurrency_ID));
	}

	/** Get C_BPG_InvAcctByCurrency.
		@return C_BPG_InvAcctByCurrency	  */
	public int getC_BPG_InvAcctByCurrency_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_BPG_InvAcctByCurrency_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
    ...
    {
        return new KeyNamePair(get_ID(), String.valueOf(getC_BPG_InvAcctByCurrency_ID()));
    }

	/** Set C_BPG_InvAcctByCurrency_UU.
		@param C_BPG_InvAcctByCurrency_UU C_BPG_InvAcctByCurrency_UU	  */
	public void setC_BPG_InvAcctByCurrency_UU (String C_BPG_InvAcctByCurrency_UU)
	{
		set_Value (COLUMNNAME_C_BPG_InvAcctByCurrency_UU, C_BPG_InvAcctByCurrency_UU);
	}

	/** Get C_BPG_InvAcctByCurrency_UU.
		@return C_BPG_InvAcctByCurrency_UU	  */
	public String getC_BPG_InvAcctByCurrency_UU () 
	{
		return (String)get_Value(COLUMNNAME_C_BPG_InvAcctByCurrency_UU);
	}
