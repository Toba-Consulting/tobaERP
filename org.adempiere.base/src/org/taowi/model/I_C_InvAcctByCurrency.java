...
/** Generated Interface for C_InvAcctByCurrency
 *  @author iDempiere (generated) 
 *  @version Release 3.1
 */
public interface I_C_InvAcctByCurrency 
{

    /** TableName=C_InvAcctByCurrency */
    public static final String Table_Name = "C_InvAcctByCurrency";

    /** AD_Table_ID=300349 */
    public static final int Table_ID = 300349;
    ...
    /** Column name C_InvAcctByCurrency_ID */
    public static final String COLUMNNAME_C_InvAcctByCurrency_ID = "C_InvAcctByCurrency_ID";

	/** Set C_InvAcctByCurrency	  */
	public void setC_InvAcctByCurrency_ID (int C_InvAcctByCurrency_ID);

	/** Get C_InvAcctByCurrency	  */
	public int getC_InvAcctByCurrency_ID();

    /** Column name C_InvAcctByCurrency_UU */
    public static final String COLUMNNAME_C_InvAcctByCurrency_UU = "C_InvAcctByCurrency_UU";

	/** Set C_InvAcctByCurrency_UU	  */
	public void setC_InvAcctByCurrency_UU (String C_InvAcctByCurrency_UU);

	/** Get C_InvAcctByCurrency_UU	  */
	public String getC_InvAcctByCurrency_UU();
