...
@org.adempiere.base.Model(table="T_MatchAllocation")
public class X_T_MatchAllocation extends PO implements I_T_MatchAllocation, I_Persistent 
{
	...
	/** Set T_MatchAllocation.
		@param T_MatchAllocation_ID T_MatchAllocation	  */
	...
	{
		set_Value (COLUMNNAME_T_MatchAllocation_UU, T_MatchAllocation_UU);
	}
