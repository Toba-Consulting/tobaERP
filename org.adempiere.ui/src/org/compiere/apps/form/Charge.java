...
{	
    ...
    private MAccount getAccount(int elementValueId)
    {
        ...
        MAccount account = MAccount.get(ctx,
            ...
            defaultAccount.getUser5_ID(),
            defaultAccount.getUser6_ID(),
            defaultAccount.getUser7_ID(),
            defaultAccount.getUser8_ID(),
            defaultAccount.getUser9_ID(),
            defaultAccount.getUser10_ID(),
            defaultAccount.getUserElement1_ID(),
            defaultAccount.getUserElement2_ID(),
            defaultAccount.getUserElement3_ID(),
            defaultAccount.getUserElement4_ID(),
            defaultAccount.getUserElement5_ID(),
            defaultAccount.getUserElement6_ID(),
            defaultAccount.getUserElement7_ID(),
            defaultAccount.getUserElement8_ID(),
            defaultAccount.getUserElement9_ID(),
            defaultAccount.getUserElement10_ID(),
            m_trxName);
