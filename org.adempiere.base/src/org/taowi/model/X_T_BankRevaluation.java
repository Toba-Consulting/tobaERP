...
public class X_T_BankRevaluation extends PO implements I_T_BankRevaluation, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20170325L;
	...
	/** Set Amt Reval Diff.
		@param AmtRevalDiff Amt Reval Diff	  */
    ...
    {
        return new KeyNamePair(get_ID(), String.valueOf(getT_BankRevaluation_ID()));
    }
	...
	{
		set_Value (COLUMNNAME_T_BankRevaluation_UU, T_BankRevaluation_UU);
	}
